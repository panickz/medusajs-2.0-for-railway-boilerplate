...
>
  Your browser does not support the video tag.
    ...
    <div
      className="absolute inset-0 flex flex-col justify-end p-8 md:p-16 text-white bg-gradient-to-t from-black/40 to-transparent">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="text-center">
          <div className="flex justify-center mb-6">
            <div
              className="w-16 h-16 flex items-center justify-center border border-black rounded-full">
              <ShoppingBag className="h-8 w-8" />
            </div>
          </div>
          <h3 className="text-lg font-medium mb-2">Complimentary Delivery</h3>
          <p className="text-neutral-600">Enjoy free shipping on all orders</p>
        </div>
          ...
          <div className="flex justify-center mb-6">
            <div
              ...
              <svg
                ...
                <path d="M7 22H17" stroke="currentColor" strokeWidth="2" />
              </svg>
            </div>
          </div>
          <h3 className="text-lg font-medium mb-2">Personalisation</h3>
          <p className="text-neutral-600">Make your Louis Vuitton uniquely yours</p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-neutral-600">Our advisors are available to help you</p>
        </div>
      </div>
    </div>
  </section>
